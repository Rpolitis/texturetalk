...
const Q3Density = () => {
    return (
        <div style={{ textAlign: "center"}} className="main1">
            ...
            <h4 class = 'newh4'>Tip: Compare a single strand of hair to a sewing thread.</h4>
            <h4 class = 'newh4'> A thinner strand would be considered low density while a thicker strand would be considered high density.</h4>
