    ...
    return (
        <div style={{ textAlign: "center", marginTop: "50px" }} className="main">
            ...
            <div className="button-container">
                <Link to={"/quizresults"}> <button className="hair-type-button">Low</button></Link>
                <Link to={"/quizresults"}> <button className="hair-type-button">Well-Balanced</button></Link>
                <Link to={"/quizresults"}> <button className="hair-type-button">High</button></Link>
            </div>
        </div>
    );
};
