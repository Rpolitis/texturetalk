        ...
        <Paper className="paper" sx={{borderRadius: '0px', padding: '50px', border: '1px solid black', borderTop: '0', backgroundColor: 'whitesmoke'}} >
            <form autoComplete="off" noValidate onSubmit={handleSubmit}>
                ...
                <div className="buttons">
                    <Button sx={{ color: "rgb(201, 26, 137)", borderColor: "rgb(21, 21, 21)", ":hover": {color: "whitesmoke", backgroundColor: "rgb(21, 21, 21)", borderColor: "whitesmoke"}}} contained type="submit" fullWidth >Submit</Button>
