        ...
        <Paper className="paper" sx={{borderRadius: '0px', padding: '50px', border: '1px solid black', borderTop: '0', backgroundColor: 'whitesmoke'}} >
            <form autoComplete="off" noValidate onSubmit={handleSubmit}>
                ...
                <div className="fileInput">
                    <FileBase sx={{paddingBottom: '10px'}} type="file" multiple={false} onDone={({base64}) => setPostData({ ...postData, selectedFile: base64})}/>
                </div>
                <div className="buttons">
                    <Button sx={{ color: "rgb(201, 26, 137);", paddingTop: '10px'}} className="submit" type="submit" fullWidth >Submit</Button>
                    <Button sx={{ color: "rgb(21, 21, 21);"}} onClick={clear} fullWidth>Clear</Button>
                </div>
            </form>
        </Paper>
    );
